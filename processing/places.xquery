...
(: Read authority file :)
declare variable $authorityentries := doc("../tei-qa/places.xml")/tei:TEI/tei:text/tei:body//(tei:listPlace/tei:place|tei:listOrg/tei:org)[@xml:id];
...
declare variable $allinstances :=
    for $instance in collection('../tei-qa?select=*.xml;recurse=yes')//tei:msDesc//(tei:placeName|tei:country|tei:settlement|tei:region|tei:orgName)[not(ancestor::tei:msIdentifier)]
